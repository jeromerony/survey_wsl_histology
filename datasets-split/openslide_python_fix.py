# ====================================================================================================
#                                  COPY-PASTE OPELSLIDE.LOWLEVEL._LOAD_IMAGE
# SEE: https://github.com/openslide/openslide-python/issues/31#issuecomment-461795559
#                          DEPENDING ON THE SIZE OF THE PATCH WE USE THE APPROPRIATE FUNCTION
#           THE ONE THAT DOES NOT CAUSE AN ERROR WHEN THERE ARE MORE THAN 2**29 PIXELS IN THE PATCH
